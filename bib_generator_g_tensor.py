...
folder_input = '/Users/david/David/Group_members/Cebreiro_Antonio/Projects/g_tensor/Paper/bolvin_g-tensor/'
file_input = 'bolvin_g-tensor_aik.tex'
paper_file = folder_input + file_input
abbr_file = 'abbr.bib'
abbr_orig_file = '/Users/david/Software/BIBINPUTS/' + abbr_file
...
for path, subdirs, files in os.walk('/Users/david/David/Group_members/Cebreiro_Antonio/Projects/g_tensor/Paper/bolvin_g-tensor/.'):
    for name in files:
